...
class TestRooms < MiniTest::Test
  def setup
    ...
    @guest2 = Guest.new("Claire", "Bohemian Rhapsody", 50, :vodka, 0)
    @guest3 = Guest.new("Mike", "under pressure", 50, :pernod, 0)
    @guest4 = Guest.new("Bruce", "Fishermans Blues", 50, :whisky, 0)
    @guest5 = Guest.new("Fiona", "walk this way ", 50, :wine, 0)
    @guest6 = Guest.new("Andy", "Blue in Green", 50, :beer, 0)
    @guest7 = Guest.new("Gayle", "Settling", 50, :water, 0)
